...
export class Challenge1Component implements OnInit {
  ...
  //     this.data = this.items[i].price;
  //     let countit = this.data + this.funcButton;
  //      countit = this.data
  ...
  // funcButton(items:Item){
  //   this.data + 1;
  //   console.log('selected' + items.name);
  // }

  // dataItems(Item:any){
  //   return this.items.forEach((data:any) => {
  //     // console.log(data)
  //   });
  }
